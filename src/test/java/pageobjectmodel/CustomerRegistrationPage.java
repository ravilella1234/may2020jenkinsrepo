...
public class CustomerRegistrationPage extends BaseTest
{
	...
	public void customerRegistration() throws InterruptedException
	{
		...
		//custEmail.sendKeys("qatest954588@gmail.com");
		custEmail.sendKeys(p.getProperty("fname")+p.getProperty("lname")+randomNum()+p.getProperty("domain"));
		String val = custEmail.getAttribute("value");
		System.out.println(val);
		Submit.click();
		
		//Thread.sleep(2000);
		waitforElement(30, Title_gen1);
